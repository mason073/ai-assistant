            ...
            <div
              ...
              className={classNames(styles.step, {
                ...
                [styles.clickable]:
                  ...
                  (step.stats?.resultsCount || step.stats?.chartsCount),
              })}
              onClick={() => {
                  ...
                  <div className={styles.tags}>
                    {step.stats.sectionsCount ? (
                      <span className={styles.tag}>
                        {step.stats.sectionsCount} 个章节
                      </span>
                    ) : null}
                    {step.stats.resultsCount ? (
                      <span className={styles.tag}>
                        {step.stats.resultsCount} 条结果
                      </span>
                    ) : null}
                    {step.stats.sourcesCount ? (
                      <span className={styles.tag}>
                        {step.stats.sourcesCount} 个来源
                      </span>
                    ) : null}
                    {step.stats.chartsCount ? (
                      <span className={classNames(styles.tag, styles.chartTag)}>
                        {step.stats.chartsCount} 个图表
                      </span>
                    ) : null}
                    {step.stats.entitiesCount ? (
                      <span className={styles.tag}>
                        {step.stats.entitiesCount} 个实体
                      </span>
                    ) : null}
                    {step.stats.wordCount ? (
                      <span className={styles.tag}>
                        {step.stats.wordCount} 字
                      </span>
                    ) : null}
                  </div>
                )}

    ...
    tooltip: {
      ...
      formatter: (params: any) => {
        if (params.dataType === 'node') {
          const typeLabel =
            typeConfig[params.data.nodeType]?.label || params.data.nodeType
  ...
  return (
    <div className={styles.graph}>
      <div className={styles.stats}>
        知识图谱 · {data.stats?.entitiesCount || data.nodes.length} 个实体 ·{' '}
        {data.stats?.relationsCount || data.edges.length} 条关系
      </div>
